...
Status: Honbabseoul instance file.

Scope: This file records the current user's collaboration preferences for this workspace. Do not reuse it as a generic Hermes default.
