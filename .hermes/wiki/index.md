...
| `pages/honbabseoul-conventions.md` | Honbabseoul product, stack, coding, and verification conventions | `raw/source-manifest.md` | 2026-05-03 |
| `pages/honbabseoul-state.md` | Current cutover state and next product work | `raw/source-manifest.md`, `.hermes/archive/legacy-harness-2026-05-03/` | 2026-05-03 |
...
| `../policy/agent-workflow.md` | Local Claude/Codex plan, verification, implementation, and closeoff workflow |
